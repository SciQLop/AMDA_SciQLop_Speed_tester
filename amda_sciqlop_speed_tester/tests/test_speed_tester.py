...
from amda_sciqlop_speed_tester import speed_tester


@pytest.fixture
def window(qtbot):
    """Pass the application to the test functions via a pytest fixture."""
    new_window = speed_tester.AMDA_SciQLop_Speed_tester()
...
def test_window_title(window):
    ...
    assert window.windowTitle() == 'AMDA_SciQLop_Speed_tester'
